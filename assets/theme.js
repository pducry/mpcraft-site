...
(function () {
  function buildRadarSVG(v) {
    ...
    var s = '';
    // filled grid levels (subtle)
    [1,2,3].forEach(function(lv){
      s += '<polygon points="'+pts(lv)+'" fill="'+(lv===3?'rgba(99,102,241,0.04)':'none')+'" stroke="rgba(99,102,241,0.15)" stroke-width="1"/>';
    });
    // axes
    ...
    s += '<polygon points="'+dataPts+'" fill="rgba(99,102,241,0.25)" stroke="rgba(129,140,248,1)" stroke-width="2" stroke-linejoin="round"/>';
    // dots
